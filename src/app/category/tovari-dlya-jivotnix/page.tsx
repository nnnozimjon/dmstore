...
export default function TovariDlyaKivotnixCategoryPage() {
        ...
        <Grid className="mb-4">
          ...
          <Grid.Col span={{ lg: 9, sm: 12 }} className="mt-0 md:mt-4">
            <Flex className="border border-gray-300 md:rounded-md rounded-none p-2" align={'center'} justify={'space-between'}>
              <Text className="hidden md:block">{'Найдено 192 товара в категории'} <strong>Товары для домашних животных</strong></Text>
